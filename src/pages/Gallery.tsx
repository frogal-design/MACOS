...
// Performance Optimization: Pre-sorting media at module scope
// to avoid expensive sort operations during the render loop.
...
const Gallery = () => {
  ...
  // Performance Optimization: useMemo prevents redundant filtering
  // unless the category filter actually changes.
  ...
  // of components receiving these functions as props.
