...
// Hoist static data out of the component to avoid redundant allocations on every render
const categories = ['all', 'events', 'sports', 'campus', 'clubs', 'leadership'];

// Pre-sort media array at module level to eliminate expensive sorting operations during render
...
const Gallery = () => {
  ...
  // Memoize filtered results to prevent re-filtering when unrelated state (like modal open/close) changes
