...
// Hoist static data to module scope to avoid re-allocation on every render
const CATEGORIES = ['all', 'events', 'sports', 'campus', 'clubs', 'leadership'];

// Static media data hoisted and pre-sorted to eliminate O(n log n) overhead during render
...
const Gallery = () => {
  ...
  // Use a single index to track modal state instead of redundant object + index
  ...
  }, [selectedIndex, closeModal, navigateModal]);
