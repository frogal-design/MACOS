...
// Hoisted and pre-sorted static data to optimize O(n log n) sorting in render
...
] as const).map(item => item as MediaItem).sort((a, b) => b.date > a.date ? 1 : b.date < a.date ? -1 : 0);
