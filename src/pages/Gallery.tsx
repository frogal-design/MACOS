...
// Hoisted static categories for performance
const CATEGORIES = ['all', 'events', 'sports', 'campus', 'clubs', 'leadership'];

// Hoisted and pre-sorted static media data to avoid O(n log n) sorting on every render
...
const Gallery = () => {
  ...
  // useMemo ensures filtering only happens when the filter state changes (O(n) instead of O(n log n))
