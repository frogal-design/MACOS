...
const Gallery = () => {
  ...
  // Performance optimization: Pre-sorting and hoisting static data to module scope
  // removes O(n log n) overhead from the render cycle.
  const filteredMedia = useMemo(() => {
    return filter === 'all' ? SORTED_MEDIA : SORTED_MEDIA.filter(m => m.category === filter);
  }, [filter]);

  // Derive selectedMedia from currentIndex to eliminate redundant state
