...
const Gallery = () => {
  ...
  // Memoize filtered media to avoid re-calculating and re-sorting on every render
  ...
  // Derive selected media from index to ensure state consistency
            ...
            <div className="flex gap-10">
              {CATEGORIES.map(cat => (
                <button
                  ...
                  onClick={() => {
                    setFilter(cat);
                    setCurrentIndex(-1); // Reset modal index when filter changes
                  }}
