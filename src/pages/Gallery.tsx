...
const Gallery = () => {
  ...
  // Optimization: Memoize filtered list to prevent re-filtering/sorting on unrelated state changes.
  // The base MEDIA array is pre-sorted at module scope to avoid expensive per-render sorting.
