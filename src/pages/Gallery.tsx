...
// MEDIA array is sorted once at module scope (O(n log n)) instead of on every render
...
const Gallery = () => {
  ...
  // useMemo ensures that filtering only runs when the filter state changes,
  // reducing complexity from O(n log n) to O(n) during subsequent renders.
