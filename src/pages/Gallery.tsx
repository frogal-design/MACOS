...
const Gallery = () => {
   ...
   * Memoize the filtered and sorted media list.
   * This prevents expensive filtering and sorting operations on every re-render,
   * such as when the user opens or closes the lightbox modal or navigates images.
   * Recalculates only when the 'filter' state changes.
   */
