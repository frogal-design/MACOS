...
const Gallery = () => {
  ...
  // Memoize filtered and sorted media to avoid redundant computations on each render.
  // Using string comparison for ISO dates is faster than creating Date objects.
  // We use a spread to avoid mutating the original MEDIA array.
