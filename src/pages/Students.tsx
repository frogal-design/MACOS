          ...
          <div className="flex flex-col lg:flex-row gap-24 items-center">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              <div className="aspect-[3/4] overflow-hidden border border-border grayscale hover:grayscale-0 transition-all">
                <img src="https://makererecollege.sc.ug/wp-content/uploads/slider/cache/5d8910c983d996b3be09b2818385d031/IMG_1001-scaled.jpg" className="w-full h-full object-cover" loading="lazy" />
              </div>
              <div className="aspect-[3/4] overflow-hidden border border-border grayscale hover:grayscale-0 mt-20 transition-all">
                <img src="https://makererecollege.sc.ug/wp-content/uploads/slider/cache/7d45eff89cd986b2aebac852a90543d2/20240709174657_IMG_9372.jpg" className="w-full h-full object-cover" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
